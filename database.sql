...
CREATE TABLE `clientes` (
  ...
  CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`pagamento_id`) REFERENCES `pagamentos` (`id`)
...
INSERT INTO `pagamentos` VALUES (1,'Boleto'),(2,'Cartão de crédito'),(3,'Transferência');
...
-- Dump completed on 2017-11-29  0:42:15
